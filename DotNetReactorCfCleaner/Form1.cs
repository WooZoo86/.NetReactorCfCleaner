...
namespace DotNetReactorCfCleaner
{
    public partial class Form1 : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            Context.module.Write(Path.GetDirectoryName(textBox1.Text) + "\\" + Context.module.Assembly.Name + "_nocf.exe", options);
            label2.Text = "Result : Successfully cleaned !";
        }
